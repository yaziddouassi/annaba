...
class AnnabaCreatorCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'annaba:creator';
     ...
     * @var string
     */
    protected $description = 'Create a annaba form on create';
    ...
    public function handle()
    {
        ...
        $crud = new \Annaba\Annaba\Utils\CrudCreator();
